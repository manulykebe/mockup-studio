...
<g id="XMLID_12_">
    ...
    binderElements.forEach((binder) => {
        ...
        if (button) {
            ...
            button.title = 'GxP Preparation Balance Measurement';
...
appendBalanceButtonToSampleBinderElements();
