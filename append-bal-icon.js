// add this icon as first element to div with class:
// <div class="binder__element-header-controls">


// </div>
// <button type="button" id="6d05124d-d082-4982-b373-85618e850934" aria-label="GxP Preparation Balance Measurement" data-testid="icon-button-6d05124d-d082-4982-b373-85618e850934" class="d-flex align-items-center justify-content-center text-gray-500 text-gray-700-hover text-gray-700-focus btn btn-icon"><span class="d-inline-flex align-items-center"><span class="snb-icon encoded-svg-icon d-flex align-items-center justify-content-center external-actions-icon external-actions-icon--element-icon icon-lg"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#adb5bd" height="800px" width="800px" version="1.1" id="Layer_1" viewBox="0 0 462.587 462.587" xml:space="preserve">
// <g id="XMLID_12_">
// 	<g>
